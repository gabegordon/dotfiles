...
values."
  (setq-default
   ...
   ;; and `nil'. `unused' will(require 'recentf)
   ;; not listed in variable `dotspacemacs-configuration-layers'), `all' will
   ;; lazy install any layer that support lazy installation even the layers
   ;; listed in `dotspacemacs-configuration-layers'. `nil' disable the lazy
   ;; installation feature and you have to explicitly list a laye(require 'recentf)
   ...
   ;; Paths (add-to-list 'company-backends 'company-c-headers)must have a trailing slash (i.e. `~/.mycontribs/')
...
(defun dotspacemacs/user-config ()
  ...
  (setq erc-nickserv-passwords
        `((freenode     (("gabeg" . ,freenode-pass)))))
  (erc :server "irc.freenode.net" :port 6665 :nick "gabeg")
  (setq erc-autojoin-channels-alist
        '(("freenode.net" "#emacs" "#spacemacs" "#archlinux" "#archlinux-offtopic")))
