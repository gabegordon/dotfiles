...
(custom-set-variables
 ...
 '(package-selected-packages
   '(blacken centered-cursor-mode code-cells cpp-auto-include devdocs dired-quick-sort drag-stuff dtrt-indent editorconfig elisp-def emr evil-cleverparens evil-collection evil-easymotion evil-goggles evil-lion evil-textobj-line flycheck-elsa flycheck-package flycheck-rtags forge gendoxy git-modes gitignore-templates google-c-style helm-git-grep helm-ls-git helm-lsp helm-org helm-purpose helm-xref impatient-mode importmagic inspector json-navigator lsp-origami lsp-pyright lsp-python-ms lsp-treemacs multi-line nameless nodejs-repl nose npm-mode org-superstar overseer password-generator pipenv pippel poetry prettier-js pydoc pylookup quickrun space-doc spaceline-all-the-icons spacemacs-purpose-popwin spacemacs-whitespace-cleanup sphinx-doc string-edit string-inflection symbol-overlay term-cursor treemacs-evil treemacs-icons-dired treemacs-magit treemacs-persp treemacs-projectile vim-powerline writeroom-mode yasnippet-snippets dotenv-mode evil-evilified-state font-lock+ holy-mode hybrid-mode yapfify ws-butler winum which-key web-mode web-beautify volatile-highlights vi-tilde-fringe uuidgen use-package undo-tree toc-org tagedit symon stickyfunc-enhance srefactor smeargle slim-mode scss-mode sass-mode restart-emacs rainbow-delimiters pytest pyenv-mode py-isort pug-mode popwin pip-requirements pcre2el paradox open-junk-file mmm-mode material-theme markdown-toc macrostep lsp-ui lorem-ipsum livid-mode live-py-mode link-hint json-reformat json-mode js2-refactor js-doc info+ indent-guide hungry-delete hl-todo highlight-parentheses highlight-numbers highlight-indentation hide-comnt help-fns+ helm-themes helm-swoop helm-rtags helm-pydoc helm-projectile helm-mode-manager helm-make helm-flx helm-descbinds helm-css-scss helm-company helm-c-yasnippet helm-ag google-translate golden-ratio git-timemachine git-messenger git-link gh-md fuzzy flycheck-ycmd flycheck-pos-tip flx-ido fancy-battery eyebrowse expand-region evil-visualstar evil-visual-mark-mode evil-unimpaired evil-tutor evil-surround evil-snipe evil-numbers evil-nerd-commenter evil-matchit evil-lisp-state evil-indent-plus evil-iedit-state evil-exchange evil-escape evil-ediff evil-args evil-anzu eval-sexp-fu emmet-mode elisp-slime-nav dumb-jump disaster diminish define-word cython-mode company-ycmd company-web company-statistics company-rtags company-quickhelp company-c-headers company-anaconda column-enforce-mode clean-aindent-mode ccls bm auto-yasnippet auto-highlight-symbol auto-compile android-mode aggressive-indent ace-link ace-jump-helm-line ac-ispell))
